...
let package = Package(
	...
	dependencies: [
		...
		//		.package(url: "https://github.com/german-first-iteration/eudi-lib-ios-openid4vci-swift", branch: "openid4vci-0.16-temp-changes"),
		.package(url: "https://github.com/eu-digital-identity-wallet/eudi-lib-ios-openid4vci-swift.git",exact: "0.19.0"),
